...
namespace Battleship
{
    ...
    class PlayerPanel : Panel
    {
        ...
        TurnDelegate tDelegate, enDelegate;

        public PlayerPanel(PanelPosition panelPosition, PlayerType playerType, TurnDelegate tDelegate, TurnDelegate enDelegate)
        {
